...
const artigos = [
    {id:1,
    title: 'A agenda de segurança internacional no BRICS (2009-2019) (aceito)',
    ...
    {id:2,
    title:'O modelo Steps-to-War: panorama de um programa de pesquisa (aceito)',
    ...
    {id:3,
    title:'A Construção do Pensamento sobre o Internacional na Rússia: identidades, projetos político-pragmáticos e o Ocidente (aceito)',
